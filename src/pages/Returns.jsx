                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg${isLimitedEdit ? ' pointer-events-none opacity-60 select-none' : ''}`}>
                  <div>
                    <label className="flex items-center justify-between text-sm font-medium text-gray-700 mb-1">
                      <span>Return No *</span>
                      <button type="button" onClick={() => setFormData({ ...formData, returnNo: `RET-${String(returns.length + 1).padStart(3, '0')}` })} className="text-xs text-blue-600 hover:text-blue-800 underline font-normal">Auto Generate</button>
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="flex items-center justify-between text-sm font-medium text-gray-700 mb-1">
                      <span>Invoice No (Optional)</span>
                      <button type="button" onClick={() => setFormData({ ...formData, invoiceNo: `INV-${String(returns.length + 1).padStart(3, '0')}` })} className="text-xs text-blue-600 hover:text-blue-800 underline font-normal">Auto Generate</button>
                    </label>
                    <input
                      type="text"
